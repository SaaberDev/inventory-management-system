                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            @can('settings.suppliers.edit')
                                <a href="{{ route('admin.settings.suppliers.edit', $supplier->id) }}"
                               class="btn p-0 mr-3"
                            >
                            ...
                            @endcan
                            @can('settings.suppliers.delete')
                                <a href="{{ route('admin.settings.suppliers.delete', $supplier->id) }}"
