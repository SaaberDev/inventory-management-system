<div>
    ...
    <div class="card-body table-responsive p-0">
        <table style="width: 100%" class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            @can('settings.unit.edit')
                            <a href="{{ route('admin.settings.unit.edit', $unit->id) }}"
                               class="btn p-0 mr-3"
                            >
                            ...
                            @endcan
                            @can('settings.unit.delete')
                            <a href="{{ route('admin.settings.unit.delete', $unit->id) }}"
            ...
            @empty
                <tr>
                    <td colspan="7">No Units Available</td>
                </tr>
            @endforelse
            </tbody>
        </table>
