...
@section('title', 'Sales Invoice' . ' ' . '#' . e($sale->code))
@push('styles')
    <style>
        html {
...
@section('content')
    ...
    <div class="section-2">
        ...
        <div class="sub-section right">
            <b>Payment Info:</b> <br>
            <span style="font-weight: bolder">{{ ucwords($sale->payment_method) }}</span> | <span style="font-weight: bolder">{{ ucwords($sale->payment_status) }}</span>
        </div>
    </div>
    ...
    <div class="section-3">
        <table class="table">
            ...
            <tr>
                ...
                <td class="grand total">{{ $sale->sub_total }} Tk</td>
            </tr>
            <tr>
                <td></td>
                <td></td>
                ...
                <td class="total">{{ $sale->transport_cost }} Tk</td>
            </tr>
            ...
            <tr>
                ...
                <td class="grand total">{{ $sale->grand_total }} Tk</td>
            </tr>
            <tr>
                <td></td>
                <td></td>
                ...
                <td class="total">{{ $sale->total_paid }} Tk</td>
            </tr>
            <tr>
                <td></td>
                <td></td>
                ...
                <td class="total">{{ $sale->total_due }} Tk</td>
            </tr>
            </tbody>
        </table>
    </div>
