...
@section('content')
    <div class="card">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form action="{{ route('admin.purchase.self.store') }}"
                  method="POST"
                  autocomplete="off"
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="text"
                               ...
                               placeholder="{{ old('purchase_date') ?? "Select a Purchase Date" }}"
                               required
                        >
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2bs4 {{ $errors->has('supplier.0') ? ' is-invalid' : '' }}"
                                    id="supplier"
                                    name="supplier"
                                    style="width: 100%;"
                            ...
                            >
                                ...
                                @foreach($suppliers as $supplier)
                                    <option value="{{ $supplier->id }}"
                                        {{ $supplier->id == old('supplier') ? 'selected' : '' }}
                                    >
                                        {{ $supplier->name }}
                                    </option>
                                @endforeach
                            </select>
                            @if($errors->has('supplier.0'))
                                <span class="invalid-feedback">
                                <strong>{{ $errors->first('supplier.0') }}</strong>
                            </span>
                            @endif
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            $('#total_paid').change(function () {
                ...
                var totalPaid = parseFloat($(this).val());

                if(grandTotal < totalPaid){
                    Swal.fire({
                        text:"Total paid amount can not be greater than grand total.",
                        icon: "warning",
                    })
                    $(this).val('');
                }
