...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form class="row"
                  action="{{ route('admin.settings.warehouse.update', $warehouse->id) }}"
                  method="POST"
                  autocomplete="off"
            ...
            >
                ...
                <div class="col-sm-4" style="padding: 0 40px">
                    ...
                    @endif
                    <div id="icon_picker" data-icon="{{ old('icon', $warehouse->icon) }}"></div>
                    <input type="hidden" name="icon" value="{{ old('icon', $warehouse->icon) }}">
                </div>
                <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               name="shortcut"
                               value="{{ old('shortcut', $warehouse->shortcut) }}"
