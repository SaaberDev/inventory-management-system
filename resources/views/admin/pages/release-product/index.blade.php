...
@section('title', 'Released Products')
...
@section('add-new-button')
    @can('release.create')
    <a type="button" href="{{ route('admin.release.create') }}" class="btn btn-info btn-sm float-sm-right">Add New</a>
    @endcan
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                {{-- Table Start --}}
                <div>
                    @livewire('admin.release-product.release-product-list', ['released_product_infos' => $released_product_infos])
                </div>
                {{-- Table End--}}
            </div>
            <!-- /.card -->
