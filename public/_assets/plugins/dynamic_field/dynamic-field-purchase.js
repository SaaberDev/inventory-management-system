(function(){
    ...
    const URL = '/api/dashboard/purchase';
    ...
    $(document).ready(function(){
        $('body').on('change', 'input.calculator', function(){
            ...
            let price = parseFloat($("#unitPrices-"+id).val()) > 0 ? parseFloat($("#unitPrices-"+id).val()) : 0;
            let discount = parseFloat($("#discounts-"+id).val()) > 0 ? parseFloat($("#discounts-"+id).val()) : 0;
            let subTotal = 0;
            let totalDiscount = 0;
